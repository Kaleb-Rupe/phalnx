...
![Tests](https://img.shields.io/badge/tests-2533-brightgreen)
...
# Run on-chain tests (522 LiteSVM tests — no validator needed)
...
| Security exploit scenarios                                              | 156      |
...
| Rust unit tests (cargo test)                                            | 122      |
