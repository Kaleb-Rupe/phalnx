...
//
// Counts tests across every discoverable suite in the repo and compares
// against the sum in scripts/test-counts.json. Exits non-zero on any drift.
//
// Usage:
//   node scripts/verify-test-counts.js          # check, exit 1 on drift
...
if (process.argv.includes("--json")) {
  console.log(
    JSON.stringify({ actual, actualTotal, jsonTotal, drift }, null, 2),
  );
